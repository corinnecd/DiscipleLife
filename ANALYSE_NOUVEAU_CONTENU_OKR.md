# 📊 Analyse du Nouveau Contenu - Approche OKR

**Date:** $(date)  
**Objectif:** Analyser le nouveau contenu axé sur les OKR (Objectives and Key Results) et méthodologie mesurable/quantifiable
...
- **Suivi** : Hebdomadaire, Mensuel, Trimestriel, Annuel
- **Revue hebdomadaire** à 1 semaine

---

## 📋 OBJECTIFS RÉVISÉS ET DÉTAILLÉS

### OBJECTIF 1: Attirer les âmes ou faire revenir les éloignés ou perdues

#### Séparation en 2 sous-objectifs distincts :
1. **Attirer les nouvelles âmes**
2. **Faire revenir les anciens qui ne revenaient plus**

#### Key Results (KR) - 3 mois :
- **Attirer 500 nouvelles âmes d'ici 3 mois**
- **Faire revenir 50% d'une liste de 500 personnes qui ne revenaient plus**

#### Stratégies et Actions :
- **Événements thématiques**
- **Banque alimentaire**
- **Solidarité** (que toute la ville sache qu'à ICC il y a de la solidarité)
- **Agape tous les dimanches** (responsabilité des chefs de familles)
- **Chaque tribu doit faire preuve de créativité** (agapé, tombola, innovations)
- **Regarder ce que font les autres églises qui attirent**

#### Méthode de Recensement :
- Recenser ceux qui sont partis
- Prière pour faire le tri de ceux qui sont partis
- Comment les faire revenir

#### Nouvelle Dynamique :
- **ADN de la nouvelle dynamique : ON NE PERD PERSONNE**
- **Grandir par l'amitié, l'influence**
- **Si 25% répondent à l'appel, il faut amener 4 fois plus**
- Cela prend du temps de recruter, motiver, affermir
...
#### Key Results (KR) - 3 mois :
- **50% des Nouveaux Arrivants (NA) et Nouveaux Convertis (NC) doivent revenir une fois dans le mois**
- **Proposer tous les services proposés par l'église**

#### Stratégies de Fidélisation :
- **Contact : 1 fois par semaine** (ne pas passer une semaine sans contact jusqu'à ce qu'il décide de faire de l'église son église)
- **Amitié, Services, Amour, Agape, Jeux, Randonnées** - Toutes sortes d'activités qui les amènent à rester
...
- **Responsabiliser = mettre une sainte pression**
- Les gens sont contents de se rendre utiles

#### Différence Importante :
- **FIDELISER N'EST PAS DE DONNER SA VIE À JÉSUS MAIS DE DONNER ENVIE DE REVENIR**
- **Fidéliser c'est aussi ceux qui sont déjà là de réussir**

#### Accueil des Nouveaux :
- **1er dimanche** : Présenter une personne selon ses besoins
- **1 fois par mois** : Accueil par les pasteurs
- **Important** : Toute personne qui vient une fois doit revenir ensuite

#### Services pour Fidéliser :
- Enseigner l'évangile
- Toujours poser la question : "Est-ce que quelqu'un veut qu'on prie pour lui, a un besoin ?"
- **Pourquoi donner sa vie à Jésus ?** Jésus guérit, Jésus libère
- **Être une église qui ne juge pas**
...
#### Key Results (KR) - 3 mois :
- Préparer les Familles de 70 (FD) à être formées sur 1 mois, 1 mois

#### Stratégies :
- **Créer la culture de venir à l'église pendant la semaine**
- **Lundi** : Sujet famille
- **Mardi** : Une thématique
- **Chaque jour de la semaine** : Une thématique
- Les gens viennent toujours quand les sujets les intéressent

#### Enseignement Continu :
- Tout ce qu'on n'enseigne pas, les gens ne font pas
- **Les chefs de familles doivent enseigner sur le baptême**
- Enseigner : Pourquoi suivre Jésus ? Qu'est-ce qui va t'empêcher de suivre Jésus ?
- **Qu'est-ce que le bienfait de suivre Jésus ?**
- Souviens-toi de ce qui t'a gardé à l'église

#### Transformation :
- Augmenter notre valeur et être crédible
- Les chefs de familles sont des hommes de prières et savoir partager la Parole
...
#### Vision :
- Qui sentent l'appel brûlant en eux
- Plate-forme pastorale missionnaire

#### Méthodologie :
- On peut appliquer des résultats par campus
- Application de la méthodologie OKR par campus
...
#### Concept :
- **Camps et événements évalués dans la durée**
- **2 équipements donnés par Dieu** :
  1. **L'onction** (équipement donné par Dieu)
  2. **La compétence**

#### Méthodologie :
- **Il y a l'enseignement et l'entraînement**
- Il faut l'enseignement et les exercices, la pratique
- Ce que Dieu a mis en nous
...
### OBJECTIF 8: Mettre en place un niveau plus accru de protection des âmes, une détection plus rapide des abus et des signalements des dangers, des loups ravisseurs
...
- **Assiduité, Présence à l'église**
- **Système de reporting mondial**
- **Tableau consolidé**
- **C'est la qualité de la solidité du système derrière qui fait la différence**
...
- Qui ont accepté de renoncer à eux-mêmes, de perdre leur vie afin de devenir, de retrouver, de gagner (Christ)
...
#### Comptage Séparé :
- **Il doit y avoir un comptage des disciples séparé de celui de la foule**
- **Évaluer qui sont vraiment les disciples**
- Pas 100% guerre, il faut juste avoir un peu d'avance
...
- **FIJ TOGETHER (TOUS LES MARDis, ceux qui sont dans le système, c'est celui qui est dans le système)**
...
### OBJECTIF 11: Transformer chaque nouveau converti en disciple affermi dans les 3 premiers mois de sa conversion

#### Key Result (KR) - 3 mois :
- **Transformer chaque nouveau converti en disciple EN 3 MOIS**
- **AVANT LES 3 MOIS**
...
- **Remplir le culte du matin**
- **Accueillir au moins 1000 personnes au culte de l'après-midi** (si EJP grandit jusqu'à prendre l'auditorium)
- **Sinon il faudra 2 cultes plein de 2h dans la salle Topaze**
...
#### Nouveau Objectif :
- Rajouter un objectif de protections accrue des âmes et de la famille ICC

---

## 🏗️ DYNAMIQUE D'ORGANISATION PAR LES CHEFS DE FAMILLES DE 70

### Rôle des Chefs de Familles (CF) :

#### Responsabilités :
1. **Les chefs de famille doivent développer leur groupe jusqu'à 70**
2. **Le chef de famille doit se débrouiller pour que ses 70 viennent à l'église chaque dimanche**
3. **Le chef de famille a la casquette de AP pasteur**
4. **C'est le chef de famille qui remplace le pasteur**
5. **L'église doit reposer sur des piliers**
...
#### Rôle de Berger :
- Le chef de famille c'est celui qui est un vrai berger
- De les gagner, de les fidéliser, de les coacher
...
#### Vision :
- Beaucoup ont le fardeau et veulent y aller
- Mais il y a un prix à payer
- On va d'avantage apprécier la valeur d'une âme
- On a les livres, les enseignements, le matériel, on a toute la sagesse des pères

#### Méthodologie :
- Ce qui va nous amener à payer ce prix c'est prendre au sérieux
- Quand tu te donnes pour cet objectif, tu fixes tes regards sur Dieu
- Prenons ça à cœur ce travail

#### Construction des Chefs de Familles :
- Les chefs de familles doivent se construire
- Il y a les livres mais il y a aussi la vie qui est notre message qui est nous-même, notre témoignage
...
## 📊 SYSTÈMES DE MESURE ET ÉVALUATION
...
- **Quand je fais, je montre à mes disciples**
- Le chef de famille ne doit pas déléguer l'accueil des nouveaux

### Évangélisation :
- **SORTIES TOUS LES JOURS**
- **ANAKAZO** : Obligations de résultats
- **Les églises qui grandissent font ANAKAZO car les gens ne savent pas qu'ils ont besoin de Christ**
...
### Réforme du PCNC :
- **LA RÉFORME DU PCNC VA ÊTRE MISE EN PLACE BIENTÔT**
